...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "service.seo.description": "End-to-end CRM operations with RD Station, Mautic, HubSpot, SendPulse, Make, and N8n. Segmented journeys, A/B testing, and process automation that increased open rates by 400% and reduced costs by 25%.",
  ...
  pt: {
    ...
    "service.seo.description": "Operações completas de CRM com RD Station, Mautic, HubSpot, SendPulse, Make e N8n. Jornadas segmentadas, testes A/B e automação de processos que aumentaram taxa de abertura em 400% e reduziram custos em 25%.",
