...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "hero.titleLine1": "Moving leads down the funnel —",
    "hero.titleLine2": "",
    "hero.titleHighlight": "without derailing the journey.",
    ...
    "project.nyc.title": "NYC Collision Analysis",
    ...
    "project.lbv.title": "LBV - Institutional Marketing",
    ...
    "project.monchu.title": "Monchu - Experiential Marketing",
    ...
    "service.seo.description": "End-to-end CRM operations with RD Station, Mautic, HubSpot, SendPulse, Make, and N8n. Segmented journeys, A/B testing, and process automation that increased open rates by 400%.",
    ...
    "about.credential2.description": "Segmented Journeys & Automation",
    "about.credential3.title": "400% Open Rate Increase",
    ...
    "contact.title": "Let's Build Something Worthwhile",
    ...
    "contact.error.description": "Something went wrong. Please try again or email me directly.",
    "contact.error.captcha": "Please verify you're human",
    "contact.error.captchaDescription": "Complete the captcha verification to send your message.",
  ...
  pt: {
    ...
    "hero.titleLine2": "",
    "hero.titleHighlight": "sem atropelar a jornada.",
    ...
    "project.nyc.title": "Análise de Colisões em NYC",
    ...
    "project.lbv.title": "LBV - Marketing Institucional",
    ...
    "service.seo.description": "Operações completas de CRM com RD Station, Mautic, HubSpot, SendPulse, Make e N8n. Jornadas segmentadas, testes A/B e automação de processos que aumentaram taxa de abertura em 400%.",
    ...
    "about.paragraph1": "Sendo paulistano do centro, gosto de diversidade sem barreiras. Amo música, filmes e descobrir coisas fora da curva em qualquer lugar, de Keith Haring a jogos de baralho de diferentes formas. Minha experiência em educação e em ambientes digitais me ajudou a crescer com mais criatividade, adaptação rápida e a liderar com propósito.",
    "about.paragraph2": "Movido pela criatividade e pela colaboração, transformo desafios em oportunidades de crescimento, celebro a individualidade e inspiro as equipes a alcançarem seu melhor desempenho.",
    "about.credential1.title": "8+ Anos de Experiência",
    "about.credential1.description": "CRM, Growth & Performance",
    "about.credential2.title": "50K+ Leads Gerenciados",
    "about.credential2.description": "Jornadas Segmentadas & Automação",
    "about.credential3.title": "400% Aumento em Abertura",
    ...
    "contact.success.description": "Obrigado pelo contato. Retornarei em breve.",
    "contact.error.title": "Erro ao enviar mensagem",
    "contact.error.description": "Algo deu errado. Tente novamente ou me envie um email diretamente.",
    "contact.error.captcha": "Por favor, verifique que você é humano",
    "contact.error.captchaDescription": "Complete a verificação do captcha para enviar sua mensagem.",
