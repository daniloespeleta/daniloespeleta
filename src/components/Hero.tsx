...
const Hero = () => {
  const stats = [
    ...
    { icon: BarChart3, value: "1M+", label: "Leads Generated" },
  ];
      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl">
            I help businesses scale their online presence through data-driven SEO, 
            social media campaigns, and performance marketing strategies that deliver measurable results.
          </p>
